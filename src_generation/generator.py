...
class ResNetBlock(nn.Module):
    ...
    """
    def __init__(self, in_channels: int, stride: int = 2, padding: int = 1, kernel_size : int = 3):
        """
        Creates a ResNetBlock instance
        
        Args:
            input_nc (int) : number of channels in input image
        ...
        self.model = nn.Sequential(
            ...
            nn.Conv2d(in_channels, self._out_channels, kernel_size=kernel_size, stride=stride),
